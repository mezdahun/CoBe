...
# Path to middleware folder where cobe and p34abm will communicate
MIDDLEWARE_PATH = os.getenv("MIDDLEWARE_PATH", "C:\\Users\\David\\CoBe\\middleware")
...
# Half arena size (always square)
max_abs_coord = int(os.getenv("MAX_ABS_COORD", 250))