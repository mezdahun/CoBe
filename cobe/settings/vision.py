...
start_x = os.getenv("START_X", 423)  # start cropping from this x coordinate for display_width length  345
start_y = os.getenv("START_Y", 200)  # start cropping from this y coordinate for display_height length  40
