...
display_width = os.getenv("DISPLAY_WIDTH", 1020)  # fisheye calibration maps should be adjusted to this resolution
display_height = os.getenv("DISPLAY_HEIGHT", 890)  # fisheye calibration maps should be adjusted to this resolution
