...
start_x = os.getenv("START_X", 345)  # start cropping from this x coordinate for display_width length  345
start_y = os.getenv("START_Y", 40)  # start cropping from this y coordinate for display_height length  40
crop_width = os.getenv("CROP_WIDTH", 2500)  # crop the image to this width  2500
crop_height = os.getenv("CROP_HEIGHT", 2500)  # crop the image to this height  2500
